...
fonts.FontTable = {
	MinecraftFont = {
		FontData = [[info face="Minecraft V3 Final" size=18 bold=0 italic=0 charset="" unicode=1 stretchH=100 smooth=1 aa=1 padding=1,1,1,1 spacing=1,1
...
char id=8470 x=0 y=102 width=20 height=14 xoffset=-2 yoffset=1 xadvance=18 page=0 chnl=15
		...
		FontMap = "rbxassetid://140620201788732",
	},
}
